...
namespace TestPipeServer
{
   ...
   {
      #region Fields
      protected readonly IServerUI itsServerUI;
      ...
      private static PipeMessageText ClientTextMessage = new PipeMessageText(string.Empty);
      ...
      internal void Logg(string aString) => itsServerUI.AddLogText(aString);
         ...
         switch (theMessage)
         {
            case PipeMessageUserLogin aPipeMessageUserLogin:
               ...
               else // If the user has logged in with a valid name
               {
                  ...
                  itsServerUI.UserListAddUser(theSender.Name);
                  itsServerUI.AddLogText("[" + theSender.Name + " connected]");
            ...
            case PipeMessageUserDisconnection aPipeMessageDisconnection:
               ...
               if (theSender.HasEnteredWorld)
               {
                  ...
                  itsServerUI.UserListRemoveUser(aPipeMessageDisconnection.Name);
                  itsServerUI.AddLogText("[" + aPipeMessageDisconnection.Name + " disconnected]");
               }
               break;
         }
      }
      ...
      /// </summary>
      private void ItsFormServer_FormClosingg()
      {
