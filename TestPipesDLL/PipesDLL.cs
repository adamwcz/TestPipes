...
namespace TestPipesDLL
{
   ...
   public class PipeMessageText : PipeMessage
   {
      ...
      /// Constructor
      /// </summary>
      public PipeMessageText(string theText) : base()
      {
         Text = theText;
      }
      /// <summary>
   ...
   public class PipeMessageCommand : PipeMessageText
   {
      ...
      /// Constructor
      /// </summary>
      public PipeMessageCommand(string theText, params string[] theCommandArgs) : base(theText)
      {
   ...
   public class PipeMessageImageShare : PipeMessage
   {
      ...
      /// Constructor
      /// </summary>
      public PipeMessageImageShare(Image theImage, string theFileName, string theFileSize) : base()
      {
   ...
   {
      public static PipeMessage ConvertToPipeMessage(this string theText)
      {
         if (theText[0] == '/')
         {
            string aCommandString = theText.Substring(1);
            return new PipeMessageCommand(theText, aCommandString.Split(' '));
         }
         else
            return new PipeMessageText(theText ?? string.Empty);
      }
   }
}